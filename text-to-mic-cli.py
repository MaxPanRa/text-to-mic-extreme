...
# Load environment variables from the root .env file next to the script/executable
load_dotenv(dotenv_path=Path(sys.argv[0]).resolve().parent / ".env", override=True)
